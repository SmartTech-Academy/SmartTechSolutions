            ...
            {FooterData &&
              FooterData.footerOne.map((footer, index) => (
                <div className="row row--15 mt_dec--30" key={index}>
                  ...
                  <SingleFooter classOne="offset-lg-1 col-lg-2 col-md-6 col-sm-6 col-12 mt--30" title="Useful Links" footerType={footer.usefulLinks} />



                  <SingleFooter classOne="col-lg-2 col-md-6 col-sm-6 col-12 mt--30" title="Our Company" footerType={footer.ourCompany} />
