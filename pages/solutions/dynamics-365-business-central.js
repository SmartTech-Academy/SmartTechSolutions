...
const solution = getSolutionBySlug("dynamics-365-business-central");

const Dynamics365BusinessCentralSolutionPage = () => {
  return (
    <>
      <PageHead
...
export default Dynamics365BusinessCentralSolutionPage;
