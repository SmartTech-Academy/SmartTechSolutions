...
import SmartTechEventsDetails from "@/my_components/_EventDetails/SmartTechEventsDetails";
...
const index = () => {
  ...
  return (
    ...
    <>
        ...
        <PageHead title="Event Details | SmartTech Academy" />
