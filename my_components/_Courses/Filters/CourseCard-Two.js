    ...
    <>
      ...
      >
        {course.map((data, index) => (
          <div className="course-grid-4" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800" key={index}>
            <div
            ...
            >
              <div className="rbt-card-img">
                <Link href={ROUTE.course_details+`1`}>
                  <Image src={data.courseImg} width={235} height={330} alt="Card image" />
                </Link>
              </div>
              <div className="rbt-card-body">
                ...
                <div className="rbt-card-bottom">
                  <Link className="transparent-button" href={ROUTE.course_details+data.id}>
                    Learn More
