      ...
      <div className="container">
        {CallToActionData &&
          CallToActionData.collectionFour.map((data, index) => (
            <div className="row align-items-center content-wrapper row--30 mt_dec--30 position-relative" key={index}>
              <div className="col-lg-8 mt--30 offset-lg-3">
                <div className="inner">
                  <div className="content text-left">
                    <h2 className="title" data-sal="slide-up"> {data.title} </h2>
              ...
              <div className="thumbnail">
                <Image className="w-100" src={data.img} width={272} height={386} alt="Shape Images" />
              </div>
            </div>
          ))}
      </div>
