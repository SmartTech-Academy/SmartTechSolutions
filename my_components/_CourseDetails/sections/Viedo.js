    ...
    <>
      <Link
        ...
        <div className="video-content">
          {checkMatchCourses.courseImg && (
            <Image className="w-100 rbt-radius" src={image_url("/app_images/course/course-banner.webp")} width={355} height={255} alt="Video Images" />
          )}
      ...
      <div className="content-item-content">
        ...
        <div className="add-to-card-button mt--15">
          <Link className="rbt-btn btn-gradient icon-hover w-100 d-block text-center" href="#">
