...
const StudentEditEvent = ({ usage_type }) => {
            ...
            <div className="col-lg-12">
              ...
              <div className="row g-5">
                ...
                <div className="col-lg-9">
                  ...
                  <EventForms usage_type="edit" />
                  
                  {/* <div className="rbt-dashboard-content bg-color-white rbt-shadow-box">
                    <div className="content">
                      <div className="section-title">
                        <h4 className="rbt-title-style-3"> {usage_type === "edit" ? "Edit Event" : "Re-Purpose Event"} </h4>
                      </div>
                          ...
                          <div className="row gy-5 align-items-end">
                            <div className="call-to-btn text-start text-lg-center position-relative">
                              <Link className="rbt-btn btn-lg rbt-switch-btn rbt-switch-y btn-border-gradient radius-round hover-icon-reverse" href={ROUTE.dashboardEventsCreate}>
                                <span data-text="Upload Event Image"> Update Event Image </span>
                              </Link>
                            </div>
                          </div>
                        </div>
                        ...
                        <form action="#" className="rbt-profile-row rbt-default-form row row--15">
                          <div className="col-lg-7 col-md-7 col-sm-7 col-12 mt--15">
                            <div className="rbt-form-group">
                              ...
                              <input id="Event_Title" type="text" defaultValue="Africa Technology Expo 2025" 
                          ...
                          <div className="col-lg-6 col-md-6 col-sm-6 col-12 mt--15">
                            <div className="rbt-form-group">
                              ...
                              <input id="Venue_Name" type="text" defaultValue="Eko Hotel and Suites" 
                          ...
                          <div className="col-lg-6 col-md-6 col-sm-6 col-12 mt--15">
                            <div className="rbt-form-group">
                              ...
                              <input id="event_location" type="text" defaultValue="Gbagada Phase 11, Shomolu, Lagos, Nigeria" 
                          ...
                          <div className="col-lg-5 col-md-5 col-sm-5 col-12 mt--15">
                            <div className="rbt-form-group">
                              ...
                              <input id="event_ticket_amount" type="number" defaultValue="50" style={focusedInput === "event_ticket_amount" ? { border: "2px solid #2f57ef", borderRadius: "6px" } : null} 
                          ...
                          <div className="col-12 mt--10">
                            <div className="rbt-form-group">
                              ...
                              <textarea id="About_Event" cols="20" rows="5" value={textareaText} style={focusedInput === "About_Event" ? { border: "2px solid #2f57ef", borderRadius: "6px" } : null} 
                          ...
                          <div className="col-12 mt--20">
                            <div className="rbt-form-group">
                              <Link className="rbt-btn btn-gradient" href="#"> {usage_type === "edit" ? "Update Event" : "Re-Purpose Event"} </Link>
                            </div>
                          </div>
                        </form>
                      </div>
