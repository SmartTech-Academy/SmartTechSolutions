  ...
  return (
    ...
    <>
      ...
      <div className="rbt-dashboard-content-wrapper">
        <div className="tutor-bg-photo bg_image height-350" style={{ backgroundImage: `url(${image_url('/app_images/dashboard/banner.jpg')})` }} />
        <div className="rbt-tutor-information">

          <div className="rbt-tutor-information-left">
            <div className="thumbnail rbt-avatars size-lg">
              <Image width={300} height={300} src={ image_url("/app_images/dashboard/avatar.webp") } alt="Student Avater" />
            </div>
            <div className="tutor-content">
              <h5 className="title">Ifeanyi Okeakwalam</h5>
