...
const WebDevelopmentServices = () => {
  ...
  return (
    <>
      ...
      <div className="rbt-banner-area rbt-banner-8 variation-02 breadcrumb-image-container breadcrumb-style-max-width">
        <div className="container">
          <div className="breadcrumb-content-top text-left">
            <h1 className="title"><span className="theme-gradient">{"Web App"}</span> {"Development Services"}</h1>
            <p className="description has-medium-font-size mt--20">
              {"Unleash the full potential of your business with our team of seasoned expert developers, crafting reliable, user-friendly web applications." 
              +" Our solutions are designed to deliver flawless performance and an effortless experience — ensuring your users stay engaged, no matter their "
              +"platform."}
            </p>
          </div>
        </div>
          ...
          <div className="row mb--60">
            <div className="col-lg-12">
              <div className="section-title text-center">
                ...
                <p className="description has-medium-font-size mt--20">
                  {"For over "+getYearOffset(15)+" years, SmartTech has been the trusted partner of global brands, delivering exceptional web applications through our competent team."}
                </p>
              </div>
            </div>
          </div>
          <ProjectCounters name_1={"Years of Experience"} counter_1={parseInt(getYearOffset((15)))} name_2={"Designers and Developers"} counter_2={430} name_3={"Completed Projects"} counter_3={180} />
        </div>
      </div>
      ...
      <div className="rbt-service-area bg-color-white rbt-section-gap">
        <div className="container">
          <div className="row mb--60">
            <div className="col-lg-12">
              <div className="section-title text-center">
                <h2 className="title">{"Comprehensive web development services"}</h2>
              </div>
            </div>
          </div>
          <Services data={ServicesData.web_dev_services} />
        </div>
      </div>
            ...
            <div className="row g-5 align-items-end mb--60">
              <div className="col-lg-6 col-md-12 col-12">
                <div className="section-title text-start">
                  <h2 className="title color-white"> {"From concept to completion, how we make your vision a reality."} </h2>
                  <p className="description color-white-off mt--20">
                    {"Our web development process is driven by an unwavering commitment to precision and care, ensuring each project is executed flawlessly."}
                  </p>
                </div>
              </div>
            </div>
      ...
      <ServicesProcedures data={ServiceProcedureData.web_dev_service_procedure} />
              ...
              <div className="row row--30 gy-5 align-items-center">
                ...
                <div className="col-lg-6 col-xl-7" key="1">
                  <div className="section-title">
                    <h2 className="title">{"Why we are your ideal Web Development partner"}</h2>
                    <p className="b1 mt--15">
                      {"With over "+getYearOffset(15)+" years of expertise and a track record of hundreds of successful projects, SmartTech is the go-to partner for global brands seeking top-tier web applications."}
                    </p>
                  </div>
                  ...
                  <div className="row g-5">
                    <div className="col-lg-12">
                      <ul className="rbt-list-style-1">
                        <li key="1"> <i className="feather-check"></i> A team of certified and skilled Web developers </li>
                        <li key="2"> <i className="feather-check"></i> Proficiency crafting secure and high-performance apps </li>
                        <li key="3"> <i className="feather-check"></i> Robust security measures to protect data and transactions </li>
                        <li key="4"> <i className="feather-check"></i> Scalable architecture designed for high traffic and growth </li>
                        <li key="5"> <i className="feather-check"></i> Cutting-edge technology for future-proof digital products </li>
                        <li key="5"> <i className="feather-check"></i> User-centric design for seamless experiences and engagement</li>
                        <li key="5"> <i className="feather-check"></i> Seamless integration with APIs and enterprise systems </li>
                        <li key="5"> <i className="feather-check"></i> Long-term support and continuous optimization for sustained success </li>
                      </ul>
                    </div>
                  </div>
          ...
          <div className="row mb--60">
            <div className="col-lg-12">
              <div className="section-title text-start">
                ...
                <p className="description has-medium-font-size mt--20">
                  {"We create innovative Web Development Services that empower industries to make an impact, streamline critical processes, and achieve measurable results. By leveraging the latest "
      ...
      <div className="rbt-testimonial-area bg-color-white rbt-section-gap overflow-hidden" id="testimonial">
        <div className="container">
          <ServiceFaq data={FaqData.web_dev_faqs} />
        </div>
      </div>
