    ...
    <>
      ...
      <div className="row g-5">
        {getEventData.eventSimilar.map((data, index) => (
          <div className="col-lg-6 col-md-6 col-sm-6 col-12 mt--30" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800" key={index}>
            <div className="rbt-card event-grid-card variation-01 rbt-hover">
              <div className="rbt-card-img">
                <Link href={`/pages/event-details/${index + 1}`}>
                  <Image src={data.eventImg} width={355} height={240} alt="Card image" />
              ...
              <div className="rbt-card-body">
                ...
                <div className="read-more-btn">
                  <Link className="rbt-btn btn-border hover-icon-reverse btn-sm radius-round" href={`/pages/event-details/${index + 1}`}>
      ...
      <div className="row">
        <div className="col-lg-12">
          <div className="load-more mt--60 text-center">
            <Link className="rbt-btn rbt-switch-btn btn-border" href={ ROUTE.events }>
