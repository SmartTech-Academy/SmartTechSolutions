...
const MainDemoBanner = () => {
  ...
  const img = image_url("/app_images/banner/banner.webp");
  const shape1 = image_url("/app_images/shape/shape-01.png");
  const shape2 = image_url("/app_images/shape/shape-02.png");
