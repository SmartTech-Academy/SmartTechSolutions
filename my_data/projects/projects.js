...
export const projects = [
  ...
  },
  {
    ...
    team: "6 Developers & Designers · 4 QA Engineers",
    cover: image_url("/app_images/projects/geoplox/geoplox_display_picture.png", true),
    href: ROUTE.geoplox_project,
    cta: "View Case Study",
    stack: ["NextJS", "Laravel", "Vite", "Proxy Pattern", "MySQL", "Redis", "REST API", "ReactJS", "Tailwind CSS", "WebSocket"],
  },
  // {
  //   id: 9,
  //   number: "09",
  ...
  },
  {
    ...
    industry: "Real Estate · PropTech",
    platform: "Web App · Admin Suite",
    team: "7 Designers &Developers · 3 QA Engineers",
    cover: image_url("/app_images/projects/xabi/xabi_display_picture.png", true),
    href: ROUTE.xabi_project,
    cta: "View Case Study",
    stack: ["NextJS", "Laravel", "Java", "ReactJS", "React Native", "Tailwind CSS", "Vite", "MySQL", "REST API", "Redis"],
  },
];
